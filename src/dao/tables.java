...
public class tables {
    ...
    public static void main(String[] args) {
        try {
            ...
            String billTable = "create table bill(id int primary key,name varchar(200),mobileNumber varchar(200),email varchar(200),date varchar(50),total varchar(300),createdBy varchar(200))";
